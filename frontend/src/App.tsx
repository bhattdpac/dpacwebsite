    ...
    <nav className="bg-bg-surface border-b border-border-default px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-6 text-text-muted">
          <a href="/login" className="hover:text-accent-primary transition-colors">Dashboard</a>
        ...
        <a href="/login" className="bg-accent-primary text-white px-4 py-2 rounded-md font-medium hover:bg-blue-700 transition-colors">
          Lawyer Login
        </a>
      </div>
    </nav>
    ...
    <main className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="bg-bg-surface rounded-xl border border-border-default p-12 text-center shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/signup" className="flex items-center justify-center gap-2 bg-accent-primary text-white px-8 py-3 rounded-md font-bold hover:bg-blue-700 transition-all">

      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-bg-base/80 backdrop-blur-xl border-b border-border-default/60 px-8 py-5">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-6">
            <div className="px-4 py-2 space-card rounded-xl border border-border-default/60 text-[10px] font-bold uppercase tracking-widest text-accent-tertiary">
              Read Only Mode
            </div>
          </div>
        </div>
      ...
      <main className="pt-32 pb-12 px-8 min-h-screen flex flex-col">
        <div className="max-w-7xl mx-auto w-full flex-grow flex flex-col space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            ...
            <div className="p-4 space-card rounded-2xl border border-border-default/60 text-[10px] font-bold uppercase tracking-widest text-text-muted">
              July 2024 • Uttaranchal University
            </div>
          </div>

          {/* PDF Viewer Container */}
          <div className="flex-grow w-full bg-border-default/30 rounded-[2.5rem] border border-border-default overflow-hidden relative shadow-2xl shadow-black/50">
            <iframe 
            ...
            <div className="absolute inset-0 pointer-events-none border border-border-default/60 rounded-[2.5rem]"></div>
          </div>
        </div>
      </main>

      {/* Footer CTA */}
      <footer className="py-12 px-8 border-t border-border-default/60 text-center">
